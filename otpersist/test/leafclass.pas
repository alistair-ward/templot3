...
type
  ...
  TLeafClassOwningList = class(TOTOwningList<TLeafClass>);
  TLeafClassReferenceList = class(TOTReferenceList<TLeafClass>);
...
procedure TLeafClass.Calculate;
begin
  inherited;
...
function TLeafClass.GetSum: Integer;
begin
  CheckCalculated;
  Result := FSum;
end;
