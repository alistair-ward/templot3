...
begin
  ...
  for n := 0 to FStockRail.numberOfLines - 1 do begin
    ...
    Check(line.railCode in [rdStraightStockGaugeFace, rdStraightStockOuterFace],
      Format('unexpected railCode: ', [Ord(line.railCode)]));
    Check(line.numberOfPoints > 0);
    case line.railCode of
      rdStraightStockGaugeFace: begin
      ...
      rdStraightStockOuterFace: begin
        for i := 0 to line.numberOfPoints - 1 do begin
...
procedure TTestMainsideStockRail.TestPlainTrackStraightContinuousRightHand;
var
  i: Integer;
  n: Integer;
  line: TLine;
...
procedure TTestMainsideStockRail.TestPlainTrackLeftHandStaggered;
var
  i: Integer;
  n: Integer;
  expectedMarks: Integer;
