...
begin
  ...
  //
  // Then the template has 1 elements
  // And the elements are:
  //    - the track centre-line,
  // And the centre-line points are all on the centre-line...
  //
  ...
  try
    ...
    CheckEquals(5, tt.lineCount, 'lineCount');
...
begin
  ...
  // When the template is calculated
  //
  // Then the template has 5 elements
  // And the elements are:
  //    - the track centre-line,
  //    - mainside stock rail gauge face
  //    - mainside stock rail outer face
  //    - turnout side stock rail gauge face
  //    - turnout side stock rail out face
