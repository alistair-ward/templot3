...
var
  ...
  tile_name_str: string = '';
  // 'map::'(1-5) + user name (padded with trailing spaces to 15 chars, 6-20) + map_code(21) + 'T'or'S'(tiled/screenshot)(22) + zoom_level(padded with trailing spaces to 2, 23-24) + separator'#'(25) + xtile_str(padded with trailing spaces to 10, 26-35) + separator'#'(36) + ytile_str(padded to 10, 37-46).
  ...
  map_code: integer = 0;
// 0=OpenStreetMap(tiled)    1=NLS London 1890s(tiled)     2=NLS 6-inch(tiled)   3=NLS 25-inch(screenshot)     4=NLS 50-inch(screenshot)     5=NLS 25K(screenshot)     6=URL(screenshot)
...
var
  ...
  begin
    if letter_str = 'HP' then begin
      east := 4;
      north := 12;
      EXIT;
    end;
    if letter_str = 'HT' then begin
      east := 3;
      north := 11;
      EXIT;
    end;
    if letter_str = 'HU' then begin
      east := 4;
      north := 11;
      EXIT;
    end;
    if letter_str = 'HW' then begin
      east := 1;
      north := 10;
      EXIT;
    end;
    if letter_str = 'HX' then begin
      east := 2;
      north := 10;
      EXIT;
    end;
    if letter_str = 'HY' then begin
      east := 3;
      north := 10;
      EXIT;
    end;
    if letter_str = 'HZ' then begin
      east := 4;
      north := 10;
      EXIT;
    end;
    if letter_str = 'NA' then begin
      east := 0;
      north := 9;
      EXIT;
    end;
    if letter_str = 'NB' then begin
      east := 1;
      north := 9;
      EXIT;
    end;
    if letter_str = 'NC' then begin
      east := 2;
      north := 9;
      EXIT;
    end;
    if letter_str = 'ND' then begin
      east := 3;
      north := 9;
      EXIT;
    end;
    if letter_str = 'NF' then begin
      east := 0;
      north := 8;
      EXIT;
    end;
    if letter_str = 'NG' then begin
      east := 1;
      north := 8;
      EXIT;
    end;
    if letter_str = 'NH' then begin
      east := 2;
      north := 8;
      EXIT;
    end;
    if letter_str = 'NJ' then begin
      east := 3;
      north := 8;
      EXIT;
    end;
    if letter_str = 'NK' then begin
      east := 4;
      north := 8;
      EXIT;
    end;
    if letter_str = 'NL' then begin
      east := 0;
      north := 7;
      EXIT;
    end;
    if letter_str = 'NM' then begin
      east := 1;
      north := 7;
      EXIT;
    end;
    if letter_str = 'NN' then begin
      east := 2;
      north := 7;
      EXIT;
    end;
    if letter_str = 'NO' then begin
      east := 3;
      north := 7;
      EXIT;
    end;
    if letter_str = 'NQ' then begin
      east := 0;
      north := 6;
      EXIT;
    end;
    if letter_str = 'NR' then begin
      east := 1;
      north := 6;
      EXIT;
    end;
    if letter_str = 'NS' then begin
      east := 2;
      north := 6;
      EXIT;
    end;
    if letter_str = 'NT' then begin
      east := 3;
      north := 6;
      EXIT;
    end;
    if letter_str = 'NU' then begin
      east := 4;
      north := 6;
      EXIT;
    end;
    if letter_str = 'NV' then begin
      east := 0;
      north := 5;
      EXIT;
    end;
    if letter_str = 'NW' then begin
      east := 1;
      north := 5;
      EXIT;
    end;
    if letter_str = 'NX' then begin
      east := 2;
      north := 5;
      EXIT;
    end;
    if letter_str = 'NY' then begin
      east := 3;
      north := 5;
      EXIT;
    end;
    if letter_str = 'NZ' then begin
      east := 4;
      north := 5;
      EXIT;
    end;
    if letter_str = 'OV' then begin
      east := 5;
      north := 5;
      EXIT;
    end;
    if letter_str = 'SA' then begin
      east := 0;
      north := 4;
      EXIT;
    end;
    if letter_str = 'SB' then begin
      east := 1;
      north := 4;
      EXIT;
    end;
    if letter_str = 'SC' then begin
      east := 2;
      north := 4;
      EXIT;
    end;
    if letter_str = 'SD' then begin
      east := 3;
      north := 4;
      EXIT;
    end;
    if letter_str = 'SE' then begin
      east := 4;
      north := 4;
      EXIT;
    end;
    if letter_str = 'SH' then begin
      east := 2;
      north := 3;
      EXIT;
    end;
    if letter_str = 'SJ' then begin
      east := 3;
      north := 3;
      EXIT;
    end;
    if letter_str = 'SK' then begin
      east := 4;
      north := 3;
      EXIT;
    end;
    if letter_str = 'SM' then begin
      east := 1;
      north := 2;
      EXIT;
    end;
    if letter_str = 'SN' then begin
      east := 2;
      north := 2;
      EXIT;
    end;
    if letter_str = 'SO' then begin
      east := 3;
      north := 2;
      EXIT;
    end;
    if letter_str = 'SP' then begin
      east := 4;
      north := 2;
      EXIT;
    end;
    if letter_str = 'SR' then begin
      east := 1;
      north := 1;
      EXIT;
    end;
    if letter_str = 'SS' then begin
      east := 2;
      north := 1;
      EXIT;
    end;
    if letter_str = 'ST' then begin
      east := 3;
      north := 1;
      EXIT;
    end;
    if letter_str = 'SU' then begin
      east := 4;
      north := 1;
      EXIT;
    end;
    if letter_str = 'SV' then begin
      east := 0;
      north := 0;
      EXIT;
    end;
    if letter_str = 'SW' then begin
      east := 1;
      north := 0;
      EXIT;
    end;
    if letter_str = 'SX' then begin
      east := 2;
      north := 0;
      EXIT;
    end;
    if letter_str = 'SY' then begin
      east := 3;
      north := 0;
      EXIT;
    end;
    if letter_str = 'SZ' then begin
      east := 4;
      north := 0;
      EXIT;
    end;
    if letter_str = 'TA' then begin
      east := 5;
      north := 4;
      EXIT;
    end;
    if letter_str = 'TF' then begin
      east := 5;
      north := 3;
      EXIT;
    end;
    if letter_str = 'TG' then begin
      east := 6;
      north := 3;
      EXIT;
    end;
    if letter_str = 'TL' then begin
      east := 5;
      north := 2;
      EXIT;
    end;
    if letter_str = 'TM' then begin
      east := 6;
      north := 2;
      EXIT;
    end;
    if letter_str = 'TQ' then begin
      east := 5;
      north := 1;
      EXIT;
    end;
    if letter_str = 'TR' then begin
      east := 6;
      north := 1;
      EXIT;
    end;
    if letter_str = 'TV' then begin
      east := 5;
      north := 0;
      EXIT;
    end;
...
begin
  ...
  if east = -1 then begin
    ShowMessage('Invalid OS Grid letters.' + #13 + #13 +
      'The letters must be 2 valid grid letters marking an area 100km square in the UK.'
      +
  ...
  if (east_chars < 1) or (east_chars > 5) or (north_chars < 1) or (north_chars > 5) then begin
    ShowMessage('Invalid OS Grid reference.' + #13 + #13 +
      'Grid numbers with letters must contain at least 1 and not more than 5 digits.'
  ...
  case east_chars of
    ...
    1:
      easting_str := easting_str + '0000';
    2:
      easting_str := easting_str + '000';
    3:
      easting_str := easting_str + '00';
    4:
      easting_str := easting_str + '0';
  ...
  case north_chars of
    ...
    1:
      northing_str := northing_str + '0000';
    2:
      northing_str := northing_str + '000';
    3:
      northing_str := northing_str + '00';
    4:
      northing_str := northing_str + '0';
  ...
  try
    ...
    ShowMessage('Invalid OS Grid reference.' + #13 + #13 +
      'Grid numbers must contain valid digits 0-9 only.');
    got_osgrid := False;
    EXIT;
  end;//try
...
begin
  ...
  if Pos('maps.nls.uk/view/', url_str) > 0 then begin
    ...
    try
      ...
      zoom_str := Copy(url_str, 1, 2);
      // might be 2 digits   ignore "lat" and "lon" pixels (if present)

      if Pos('&', zoom_str) > 0 then
        zoom_str := Copy(url_str, 1, 1);   // was only 1.

      zoom_level := StrToInt(zoom_str);
    except
      ShowMessage('error - Unable to read zoom level from URL.'
        + #13 + #13 +
        'Please be sure to click "Link to this view" at the bottom of the map,'
        +
    ...
    if parse_url(url_str, zoom_level, lat_lon) = False then begin
  ...
  then begin
    putdim('Enter the required position for the bottom-left corner of the map on the trackpad.', 1, 'map  corner  X  position  ( from  left )', shotx, False, True, False, False);
    ...
    if getdims('map  position  on  trackpad', '', map_loader_form, n, od) =
      True then begin
      shotx := od[0];
      shoty := od[1];
    end
  ...
  then begin
    ...
    case sheet_code of
      ...
      1:
        scan_factor := 8 * 7905 / 1860;   // = 34 proto-feet per screen dot (at zoom 0)
      ...
      4:
        scan_factor := 8 * 1640 / 1420;  // 1:1250 500m square = 9.24 proto-ft  per dot at zoom 0

      else
        scan_factor := 24;  // sheet_code 5   arbitrary  proto-feet per screen dot at zoom 0.
    ...
    map_width_mm := ABS(156543033.928 * COS(lat_lon.lat * Pi / 180) * grab_width * scale / 304.8 /
      Power(2, zoom_level));
  ...
  with new_shape do begin
    ...
    shape_name := 'map::' + format_his_name + Copy(IntToStr(map_code), 1, 1) + 'S' + Copy(
      zoom_str + '  ', 1, 2) + ' screenshot';

    shape_code := -1;   // -1=picture
    shape_style := 0;   // not used

    wrap_offset := 0;
    show_transparent := map_loader_form.transparent_checkbox.Checked;
    // 215b  was  show_transparent:=False;
  ...
  if bgnd_form.bgnd_shapes_listbox.Items.Count > 0 then
  ...
  ShowMessage('The screenshot has been made and should now be visible as a picture shape on the trackpad behind this message.'
    + #13 + #13 + 'If not, click on the trackpad and then press the SHIFT+HOME keys to toggle background shapes on and off.' + #13 + #13 + 'To remove any headings and other extraneous content, use the crop/combine function on the background shapes dialog.');
...
begin
  ...
  if FileExists(ExtractFilePath(Application.ExeName) + 'ot_screenshot_capture.exe.manifest') =
    False then
    manifest_memo.Lines.SaveToFile(ExtractFilePath(Application.ExeName) +
      'ot_screenshot_capture.exe.manifest');
...
begin
  ...
  if alert(7, '    cancel  capture ?',
    ...
    '||Has the screenshot capture window stopped responding?', '', '', '', '', 'yes', 'no', 0) = 5 then
  begin
...
procedure Tmap_loader_form.map_load_groupboxMouseMove(Sender: TObject;
...
procedure Tmap_loader_form.location_groupboxMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
...
procedure Tmap_loader_form.lon_editEnter(Sender: TObject);
// also lat edit Enter , lat_lon radio click
...
begin
  ...
  name_str := Copy(Trim(map_loader_form.name_edit.Text) + '                    ', 1, 15);
  // pad with spaces to 15 characters

  // check and remove any UTF or control chars in his name ..

  for n := 1 to Length(name_str) do begin
    if (Ord(name_str[n]) < 32) or (Ord(name_str[n]) > 127) or (name_str[n] = '#') then
      name_str[n] := '_';    // # is our separator
  end;//next
...
begin
  ...
  if (map_code < 0) or (map_code > 2) then
    EXIT;   // ??? not a tiled map
  ...
  repeat
    if getting_tile = False then
      BREAK
    else
      Sleep(200);  // wait for previous tile to finish

    Inc(http_count);
    if http_count > 50    // 10 seconds
    then begin
      ShowMessage('Sorry, unable to obtain the map tile. The server is taking too long to respond.'
  ...
  tile_name_str := map_name_str + Copy(IntToStr(map_code), 1, 1) + 'T' + Copy(
    zoom_str + '  ', 1, 2) + '#' + Copy(xtile_str + '          ', 1, 10) + '#' + Copy(ytile_str + '          ', 1, 10);
  ...
  try
    ...
    if (http_sender.ResultCode >= 100) and (http_sender.ResultCode <= 299) then begin
      ...
      ShowMessage('Sorry, unable to obtain the map tiles. Web site code: ' +
        IntToStr(http_sender.ResultCode) + #13 + #13 +
        'You may have set a location outside the area covered by the selected map series.'
        + #13 + #13 + 'You may have set a zoom level outside the valid range for this map series.'
        + #13 + #13 + 'For NLS maps, the API subscription may have expired. Please ask on the Templot Club user forum.' + #13 + #13 + 'Otherwise please check your internet connection, or try again later.');
...
begin
  ...
  with bgnd_form.bgnd_shapes_listbox.Items do begin
    ...
    for n := 0 to Count - 1 do begin
      ...
      if Pos(map_name_str, Strings[n]) = 1 then begin
        shape_str := Strings[n];
        ...
        then begin
          ...
          begin
            ShowMessage(
              'error - Sorry, unable to identify all map tiles.');
            EXIT;
          end;
          ...
          if screenx <
            ((ytile_min_p2.y - ytile_max_p1.y) * margin_factor * wl_factor) then
            screenx := (ytile_min_p2.y - ytile_max_p1.y) * margin_factor * wl_factor;
          ...
          if wl_factor > minfp then
            zoom_offsety := ytile_max_p1.y - (screenx / wl_factor - (ytile_min_p2.y - ytile_max_p1.y)) / 2;
...
begin
  ...
  if (Pos('maps.nls.uk', str) = 0) and (Pos('openstreetmap.org', str) = 0) and
    (Pos('google.co.uk/maps', str) = 0) and (Pos('google.com/maps', str) = 0) and
    (Pos('ordnancesurvey.co.uk', str) = 0) then begin
    ShowMessage('error - Invalid URL.' + #13 + #13 +
      'Only NLS, OpenStreetMap, Google, OrdnanceSurvey map pages are supported.');
    EXIT;
  end;

  //http://maps.nls.uk/geo/explore/#zoom=15&lat=52.3754&lon=-2.3161&layers=171&b=6   example

  if Pos('maps.nls.uk', str) <> 0 then begin
    ...
    try
      ...
      ShowMessage('error - Unable to read NLS URL.' + #13 + #13 +
        'Copy it from your browser address bar when displaying a map at the required location.');
      EXIT;
    end;//try
  ...
  if Pos('openstreetmap.org', str) <> 0 then begin
    n := Pos('#map=', str);
    Delete(str, 1, n + 4);
    ...
    try
      ...
      ShowMessage('error - Unable to read OpenStreetMap URL.' + #13 + #13 +
        'Copy it from your browser address bar when displaying a map at the required location.');
      EXIT;
    end;//try
  ...
  if Pos('google.co', str) <> 0 then begin
    n := Pos('/maps/@', str);
    Delete(str, 1, n + 6);
    ...
    try
      ...
      ShowMessage('error - Unable to read Google URL.' + #13 + #13 +
        'Copy it from your browser address bar when displaying a map at the required location.');
      EXIT;
    end;//try
  ...
  if Pos('osmaps.ordnancesurvey.co.uk', str) <> 0 then begin
    n := Pos('.co.uk/', str);
    Delete(str, 1, n + 6);
    ...
    try
      ...
      ShowMessage('error - Unable to read Ordnance Survey URL.' + #13 +
        #13 + 'Copy it from your browser address bar when displaying a map at the required location.');
      EXIT;
    end;//try
...
begin
  if (gauge_i = t_T55_i) and (scale = 5.5) and (g = 25.4) then begin
  ...
  if load_button.Tag = 1 then begin
    zoom_to_map;
    EXIT;
  end;

  if map_loading_in_progress = True then
    EXIT;

  if osm_radio_button.Checked = True then
    map_code := 0
  else
  if nls_london_radio_button.Checked = True then
    map_code := 1
  else
  if nls_6inch_radio_button.Checked = True then
    map_code := 2
  else
  if screenshot_25inch_radio_button.Checked = True then
    map_code := 3
  else
  if screenshot_50inch_radio_button.Checked = True then
    map_code := 4
  else
  if screenshot_25k_radio_button.Checked = True then
    map_code := 5
  else
  if other_screenshot_url_radio_button.Checked = True
  then
    map_code := 6
  ...
  then begin
    ShowMessage('Error - there is already one or more background shapes with the name: "' +
      map_name_str + '"' + #13 + #13 +
      'Please enter a different name. Simply adding a suffix should be sufficient, for example: ' + name_str
      +
      '-A' + #13 + #13 + '(Providing the new name does not exceed 15 characters.)');
    EXIT;
  end;
  ...
  case location_code of
    ...
    0: begin      // long/lat
      ...
      if (ABS(lat_lon_org.lon) > 180) or (ABS(lat_lon_org.lat) > 85) then begin
    ...
    1: begin      // entered OS Grid ...
      ...
      if (Length(easting_str) = 6) and (Length(northing_str) = 6)
      // 6-digits, no letters needed
      then begin
        try
        ...
        os_grid_org :=
          parse_os_grid(0 - 100, 25, Trim(os_letters_edit.Text), easting_str, northing_str);
        // in web_browser_unit

        if got_osgrid = False then
          EXIT;  // invalid grid letters
      end;
    ...
    2: begin                                           //  get from URL
      ...
      if parse_url(url_str, dummy_zoom, lat_lon_org) = False then
        EXIT;           // zoom ignored in URL, get location only
    end;

    3:
      lat_lon_org := previous_lat_lon;
  ...
  123:
    ...
    then begin
      putdim('Enter the required position for the bottom-left corner of the map on the trackpad.', 1, 'map  corner  X  position  ( from  left )', map_org_x, False, True, False, False);
      // negative ok, no preset, zero ok, don't terminate on zero.
      putdim('Enter the required position for the bottom-left corner of the map on the trackpad.', 1, 'map  corner  Y  position  ( from  bottom )', map_org_y, False, True, False, False);
      // negative ok, no preset, zero ok, don't terminate on zero.

      putdim(size_help_str, 1, 'width  of  mapped  area', base_width, True, True, True, False);
      // no negative, no preset, no zero, don't terminate on zero.
      n := putdim(size_help_str, 1, 'height  of  mapped  area', base_height, True, True, True, False);
      // no negative, no preset, no zero, don't terminate on zero.

      if n <> 3 then
        EXIT;

      if getdims('map  size  and  position', '', pad_form, n, od) = True then begin
  ...
  try
    ...
    case map_code of                     // trial and error ...
      ...
      0:
        zoom_level := 19;   // OSM
      1:
        zoom_level := 21;   // NLS 60-inch London
      2:
        zoom_level := 19;   // NLS 6-inch GB

      // screenshots

      3:
        zoom_level := 19;   // NLS 25-inch GB
      4:
        zoom_level := 21;   // NLS 50-inch Scotland
      5:
        zoom_level := 16;   // NLS 25K GB
      6:
        zoom_level := 19;   // URL
      else
        zoom_level := 17;   // ???
  ...
  if (zoom_level > 22) or (zoom_level < 15) then begin
  ...
  then begin
    ...
    case map_code of
      ...
      3:
        web_str := 'http://maps.nls.uk/geo/explore/#zoom=' + zoom_str + '&lat=' + FloatToStr(
          lat_lon_org.lat) + '&lon=' + FloatToStr(lat_lon_org.lon) + '&layers=168&b=4';    // 25-inch GB + aerial
      4:
        web_str := 'http://maps.nls.uk/geo/explore/#zoom=' + zoom_str + '&lat=' + FloatToStr(
          lat_lon_org.lat) + '&lon=' + FloatToStr(lat_lon_org.lon) + '&layers=170&b=7';
      // 50-inch Scotland + OSM
      5:
        web_str := 'http://maps.nls.uk/geo/explore/#zoom=' + zoom_str + '&lat=' + FloatToStr(
          lat_lon_org.lat) + '&lon=' + FloatToStr(lat_lon_org.lon) + '&layers=10&b=9a';    // 25K GB + OS 6-inch
      ...
      6: begin
        ...
        if use_location_checkbox.Checked = True
        // use domain, but add location and zoom from user settings
        then begin
          ...
          if Pos('nls', url_str) <> 0 then begin
            web_str :=
              'http://maps.nls.uk/geo/explore/#zoom=' + zoom_str + '&lat=' + FloatToStr(lat_lon_org.lat) +
              '&lon=' + FloatToStr(lat_lon_org.lon);
            n := Pos('&layers=', url_str);
            if n > 0 then
              web_str := web_str + Copy(url_str, n, 50);
          end;
          ...
          then
            web_str := 'http://www.openstreetmap.org/#map=' + zoom_str + '/' + FloatToStr(
              lat_lon_org.lat) + '/' + FloatToStr(lat_lon_org.lon);


          //http://www.google.co.uk/maps/@52.3258601,-2.274551,16z

          if Pos('google', url_str) <> 0 then
            web_str := 'http://www.google.co.uk/maps/@' + FloatToStr(lat_lon_org.lat) + ',' +
              FloatToStr(lat_lon_org.lon) + ',' + zoom_str + 'z';
          ...
          then
            web_str := 'http://osmaps.ordnancesurvey.co.uk/' + FloatToStr(lat_lon_org.lat) +
              ',' + FloatToStr(lat_lon_org.lon) + ',' + zoom_str;
        ...
        web_str := 'http://maps.nls.uk/geo/explore/#zoom=' + zoom_str + '&lat=' + FloatToStr(
          lat_lon_org.lat) + '&lon=' + FloatToStr(lat_lon_org.lon) + '&layers=10&b=4';     // 25K + OSM
    ...
    if screenshot_msg_pref = False then begin
    ...
    if cancel_clicked = True then
      EXIT;

    if do_screenshot = False then
      ShowMessage('Sorry, it has not been possible to make a screenshot background map.');
  ...
  xtile_org := xscaling * ((lat_lon_org.lon + 180) / 360);
  // in tile units (floats) ..
  ytile_org := yscaling * (1 - (LN(TAN(lat_radians) + (1 / COS(lat_radians))) / Pi));

  map_tile_size_mm := ABS(156543033.928 * COS(lat_lon_org.lat * Pi / 180) * 256 * scale /
    304.8 / Power(2, zoom_level));
  //resolution = 156543.033928 metres/pixel * cos(latitude) / (2 ^ zoomlevel)
  ...
  if (numx * numy) > 1500 then begin
    Screen.Cursor := crDefault;
    ShowMessage('Map too large. Your map area would require ' + IntToStr(
      numx * numy) + ' image tiles.' + #13 + #13 +
      'Having more than 1500 tiles could prevent rapid panning and zooming, and may overload the tile server if loaded in one go.'
      + #13 + #13 +
      'Please try again with a smaller map area. If necessary it can be extended later by adding extra rows and columns.');
    goto 123;
  end;

  seconds := Ceil(numx * numy / 4);

  if alert(7, '    ready  to  load  map', 'You are about to load ' +
    IntToStr(numx * numy) + ' map image tiles.' +
    '||To avoid impacting other users of the tile server, Templot loads tiles at a maximum rate of 4 tiles per second.'
    + '||This means your map will take at least ' + IntToStr(seconds) +
    ' seconds to load.' + '||On slow systems or connections it may take a lot longer.'
    + '|||If the map is satisfactory you can save your background shapes so that you don''t need to load the map from the server again in future, or remember the settings.', '', '', '', '', 'cancel', 'continue  -  load  map', 0) = 5 then
    EXIT;
  ...
  try
    ...
    for mapy := 0 to numy - 1 do begin     // tile row
      ...
      for mapx := 0 to numx - 1 do begin   // tile column
        ...
        if obtain_tile_from_server(zoom_str, xtile_str, ytile_str) = False then
          EXIT;

        if abort_map = True then
          EXIT;

        if show_loading_checkbox.Checked = True then
          redraw(False);   // show map loading

        if stop_loading = True then
          EXIT;
...
begin
  ...
  if not ((gauge_i = t_T55_i) and (scale = 5.5) and (g = 25.4)) then
    map_loader_form.t_55_label.Hide;
  ...
  then begin
    ...
    with bgnd_form.bgnd_shapes_listbox.Items do begin
      for n := 0 to Count - 1 do begin
        ...
        if Pos(shape_name_str, Strings[n]) = 1 then begin
          ...
          with map_loader_form do begin
            ...
            then begin
              ...
              case server of
                3:
                  current_map_label.Caption := screenshot_25inch_radio_button.Caption;
                4:
                  current_map_label.Caption := screenshot_50inch_radio_button.Caption;
                5:
                  current_map_label.Caption := screenshot_25k_radio_button.Caption;
                6:
                  current_map_label.Caption := 'screenshot  map  from  URL';
              end;//case

            end;

            if Length(shape_str) <> 46 then
              CONTINUE;      // not a map tile  (label, copyright, rectangle, screenshot)

            server := StrToInt(shape_str[21]);

            case server of
              0:
                current_map_label.Caption := osm_radio_button.Caption;
              1:
                current_map_label.Caption := nls_london_radio_button.Caption;
              2:
                current_map_label.Caption := nls_6inch_radio_button.Caption;
            end;//case
            ...
            case server of
              0, 1, 2: begin
                ...
                // screenshot maps  (should not get here)
                extend_area_groupbox.Visible := False;
                crop_area_groupbox.Visible := False;
              end;
            end;//case
    ...
    if (map_loader_form.osm_radio_button.Checked = True) or
      (map_loader_form.nls_london_radio_button.Checked = True) or
      (map_loader_form.nls_6inch_radio_button.Checked = True)    // tiled maps
    then begin
      ...
      if map_loader_form.load_button.Enabled = True then
        map_loader_form.load_button.Caption := 'show  map';    // screenshot maps
  ...
  try
    ...
    map_loader_form.location_groupbox.Visible :=
      (map_loader_form.other_screenshot_url_radio_button.Checked = False) or
      (map_loader_form.use_location_checkbox.Checked = True);
...
begin
  ...
  if Pos(shape_name_str, bgnd_shapes_text_str) <> 0 then begin
    if alert(7, '    delete  map  ' + name_str,
      ...
      '', 'yes  -  delete  map', 'no  -  cancel', '', 0) = 5 then
      EXIT;
  end
  else begin
    ...
    with bgnd_form.bgnd_shapes_listbox do begin
      with Items do begin
        ...
        repeat
          ...
          if Pos(shape_name_str, Strings[n]) <> 0 then begin
...
begin
  if name_listbox.ItemIndex > -1 then
    name_edit.Text := name_listbox.Items.Strings[name_listbox.ItemIndex];
end;
//______________________________________________________________________________
...
begin
  ...
  with bgnd_form.bgnd_shapes_listbox.Items do begin
    ...
    for n := 0 to Count - 1 do begin
      ...
      if Pos(map_str, Strings[n]) = 1 then begin
        shape_str := Strings[n];
        if Length(shape_str) <> 46 then
          CONTINUE;      // not a map tile  (label, copyright, rectangle)

        xtile := StrToInt(Trim(Copy(shape_str, 26, 10)));
        ytile := StrToInt(Trim(Copy(shape_str, 37, 10)));

        if xmax < xtile then begin
  ...
  if (xmax >= xmin) and (ymax >= ymin)    // set global tile limits ...
    ...
    and (xtile_min_p1.x <> minfp) and (ytile_min_p1.x <> minfp) and
    (xtile_max_p1.x <> minfp) and (ytile_max_p1.x <> minfp) and
    (xtile_min_p2.x <> minfp) and (ytile_min_p2.x <> minfp) and
    (xtile_max_p2.x <> minfp) and (ytile_max_p2.x <> minfp) and
    (xtile_min_p1.y <> minfp) and (ytile_min_p1.y <> minfp) and
    (xtile_max_p1.y <> minfp) and (ytile_max_p1.y <> minfp) and
    (xtile_min_p2.y <> minfp) and (ytile_min_p2.y <> minfp) and
    (xtile_max_p2.y <> minfp) and (ytile_max_p2.y <> minfp) then begin
    xtile_min := xmin;
    ytile_min := ymin;
...
begin
  ...
  if (get_tile_extents(map_name_str) = False) or (server_code = -1) or (zoom_level = -1) then begin
  ...
  try
    for mapx := 0 to numx - 1 do begin   // tile column
      ...
      if map_loader_form.show_loading_checkbox.Checked = True then
        redraw(False);   // show map loading
...
begin
  ...
  if left_column = True then begin
...
begin
  ...
  if pause_loading = True then
    pause_button.Caption := 'continue'
  else
...
begin
  if map_loading_in_progress = False then
    map_loader_form_update;
end;
//______________________________________________________________________________
...
begin
  ...
  case which_tiles of
    ...
    0: begin
      crop_tile_str := IntToStr(ytile_min);
      pos_loc := 36;
    end;   // top row   y tiles count from top

    1: begin
      crop_tile_str := IntToStr(xtile_max);
      pos_loc := 25;
    end;   // right column

    2: begin
      crop_tile_str := IntToStr(ytile_max);
      pos_loc := 36;
    end;   // bottom row

    3: begin
      crop_tile_str := IntToStr(xtile_min);
      pos_loc := 25;
    end;   // left column
  ...
  try
    ...
    then begin
      // delete the map entirely, rectangle, label
      with bgnd_form.bgnd_shapes_listbox do begin
        with Items do begin
          if Count < 1 then
            EXIT;
          ...
          repeat
            ...
            if Pos(map_name_str, Strings[n]) <> 0 then begin
              free_shape_object(n);
